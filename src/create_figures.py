...
def main():
    ...
    plt.title("Node Temperature Error Mean Deviation")
    plt.xlabel("Time (s)")
    ...
    plt.title("Node Temperature Error Standard Deviation")
    plt.xlabel("Time (s)")
    plt.ylabel("Deviation (°C)")
    ...
    plt.title("Maximum Node Temperature Error")
    plt.xlabel("Node")
    plt.ylabel("Error (°C)")
    ...
    plt.title("Maximum Absolute Node Temperature Error")
    plt.xlabel("Node")
    plt.ylabel("Error (°C)")
