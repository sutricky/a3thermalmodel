...
def main():
    ...
    plt.bar(nodes, r2)
    plt.yticks(np.arange(0,1.1,step=0.1))
    plt.title("Skor Koefisien Determinasi")
    plt.xlabel("Node")
    plt.ylabel("Skor")
    ...
    plt.title("Error Node Absolut Maksimum")
    plt.xlabel("Node")
    plt.ylabel("Error (°C)")
